...
function placeAnswer(event) {
    ...
    alert(`Red Rock Canyon National Conservancy, enough sweet bouldering to last a lifetime and a personal project called "Sad Robot" that I will guaranteed send next time I go, please god, I have to send it`)
}
...
placeClick.addEventListener(`click`, ritualAnswer)
ritualClick.addEventListener(`click`, placeAnswer)    
